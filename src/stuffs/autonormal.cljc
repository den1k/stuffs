(ns stuffs.autonormal
  "Adapted from https://github.com/lilactown/autonormal
...
(defn- lookup-ref-of
  [entity]
  (let [entity-ident #{:id} #_(if-some [ident-key (get (meta entity) :db/ident)]
                             #(= ident-key %)
                             default-ident)]
    (loop [kvs entity]
